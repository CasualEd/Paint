...
public class Window extends JFrame implements ActionListener {
    ...
    public void open(String filename){ /*This function is used to open a previous drawing and recreate it*/
        int length=0;
        Figure f=null;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(cmd){ /* We implement the actions for the different buttons here */
            ...
            case "Save":
                ...
                break;
            case "Undo": /*Delete the previously drawn figure*/
                draw.getList().remove(draw.getList().size()-1);
                draw.paintComponent(draw.getGraphics());
                break;
            case "Open":
